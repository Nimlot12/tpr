...
def add_ogr(lefr_ogr, right_ogr):
    console.print('Введите значения ограничений на каждый продукт на левую часть матрицы, добавленный вами, если на продукт нет ограничения, то введите "0"', style="bold red")
    mas_promez = []
    for i in range(len(mas1)):
        mas_promez.append(int(input()))
    left_ogr.append(mas_promez)
    console.print('Введите значения ограничений на каждый продукт на правую часть матрицы, добавленный вами, если на продукт нет ограничения, то введите "0"', style="bold red")
    right_ogr.append(int(input()))


console.print('введите количество ограничений на продукты питания, если ограничений нет, введите "0"')
count2 = int(input())
...
def add_csv():
    console.print('введите номер, название продукта, количество калорий, белков, жиров, углеводов и стоимость продукта', style="bold red")
    number = input()
    name = input()
    kk = input()
    bel = input()
